  ...
  <div id="retrievePass">
    <el-card class="card-info">
      ...
      <div style="display: flex;justify-content: center;margin-bottom: -10px">
        ...
        <h3 style="line-height: 50px;">忘记密码</h3>
      </div>
      <el-form ref="ruleForm" :model="myData.formData" :rules="myData.formRule" style="margin-top: 30px">
        ...
        <el-form-item prop='checkCode'>
          <el-input v-model="myData.formData.checkCode" placeholder="验证码" @click="getCode"></el-input>
          <div class="getCode" @click="getCode">获取验证码</div>
        </el-form-item>
        <el-form-item prop='password'>
          <el-input v-model="myData.formData.password" placeholder="设定新密码"></el-input>
        </el-form-item>
<!--<el-form-item>-->
        ...
        <el-form-item>
          <el-button type="primary" v-on:click="submit('ruleForm')" class="form_login">确认修改</el-button>
        </el-form-item>
      </el-form>
